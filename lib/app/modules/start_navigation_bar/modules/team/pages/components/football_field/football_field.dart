      ...
      children: [
        Stack(
          children: [
            ...
            Player(
              image: storeTeam.playerGol(listPlayer),
              name: storeTeam.playerName(listPlayer, 0),
            ...
            Player(
              image: storeTeam.player1(listPlayer),
              name: storeTeam.playerName(listPlayer, 1),
            ...
            Player(
              image: storeTeam.player3(listPlayer),
              name: storeTeam.playerName(listPlayer, 2),
            ...
            Player(
              image: storeTeam.player2(listPlayer),
              name: storeTeam.playerName(listPlayer, 3),
              top: 0.23636364 * fieldH,
              right: 0.0,
            ...
            Player(
              image: storeTeam.player1(listPlayer),
              name: storeTeam.playerName(listPlayer, 4),
              top: 0.21818182 * fieldH,
              right: 0.0,
            ...
            Player(
              image: storeTeam.player3(listPlayer),
              name: storeTeam.playerName(listPlayer, 5),
            ...
            Player(
              image: storeTeam.player2(listPlayer),
              name: storeTeam.playerName(listPlayer, 6),
            ...
            Player(
              image: storeTeam.player1(listPlayer),
              name: storeTeam.playerName(listPlayer, 7),
              top: 0.47272727 * fieldH,
              right: 0.47 * width,
              left: 0.0,
              position: "MEI",
            ...
            Player(
              image: storeTeam.player3(listPlayer),
              name: storeTeam.playerName(listPlayer, 8),
            ...
            Player(
              image: storeTeam.player2(listPlayer),
              name: storeTeam.playerName(listPlayer, 9),
              top: 0.69090909 * fieldH,
              right: 0.44 * width,
              left: 0.0,
              position: "ATA",
            ...
            Player(
              image: storeTeam.player1(listPlayer),
              name: storeTeam.playerName(listPlayer, 10),
              top: 0.69090909 * fieldH,
